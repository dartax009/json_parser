...
Библиотека для проверки json сигнатуры и ее обработки. В настоящее время работает только на x86 под управлением ОС Linux.

Для сборки и работы требует поддержку следующих библиотек:
- stdlib.h
- string.h
- sys/mman.h
- sys/stat.h
